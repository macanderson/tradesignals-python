...
__all__ = ["FlowDataRetrieveResponse", "FlowDataRetrieveResponseItem"]


class FlowDataRetrieveResponseItem(BaseModel):
...
FlowDataRetrieveResponse: TypeAlias = List[FlowDataRetrieveResponseItem]
