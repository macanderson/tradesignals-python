...
from ...types.market import oi_change_list_params
from ...types.market.oi_change_list_response import OiChangeListResponse
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                post_parser=DataWrapper[Optional[OiChangeListResponse]]._unwrapper,
            ),
            cast_to=cast(Type[Optional[OiChangeListResponse]], DataWrapper[OiChangeListResponse]),
        )
