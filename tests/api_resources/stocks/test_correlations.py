...
class TestCorrelations:
    ...
    def test_method_retrieve(self, client: Tradesignals) -> None:
        correlation = client.stocks.correlations.retrieve(
            symbols="symbols",
        )
    ...
    def test_raw_response_retrieve(self, client: Tradesignals) -> None:
        response = client.stocks.correlations.with_raw_response.retrieve(
            symbols="symbols",
        )
    ...
    def test_streaming_response_retrieve(self, client: Tradesignals) -> None:
        with client.stocks.correlations.with_streaming_response.retrieve(
            symbols="symbols",
        ) as response:
...
class TestAsyncCorrelations:
    ...
    async def test_method_retrieve(self, async_client: AsyncTradesignals) -> None:
        correlation = await async_client.stocks.correlations.retrieve(
            symbols="symbols",
        )
        assert_matches_type(CorrelationRetrieveResponse, correlation, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncTradesignals) -> None:
        response = await async_client.stocks.correlations.with_raw_response.retrieve(
            symbols="symbols",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncTradesignals) -> None:
        async with async_client.stocks.correlations.with_streaming_response.retrieve(
            symbols="symbols",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
