...
from tradesignals.types.etfs import HoldingListResponse
...
class TestHoldings:
    ...
    def test_method_list(self, client: Tradesignals) -> None:
        holding = client.etfs.holdings.list(
            "ticker",
        )
    ...
    def test_raw_response_list(self, client: Tradesignals) -> None:
        response = client.etfs.holdings.with_raw_response.list(
            "ticker",
        )
    ...
    def test_streaming_response_list(self, client: Tradesignals) -> None:
        with client.etfs.holdings.with_streaming_response.list(
            "ticker",
        ) as response:
    ...
    def test_path_params_list(self, client: Tradesignals) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `ticker` but received ''"):
            client.etfs.holdings.with_raw_response.list(
                "",
            )
...
class TestAsyncHoldings:
    ...
    async def test_method_list(self, async_client: AsyncTradesignals) -> None:
        holding = await async_client.etfs.holdings.list(
            "ticker",
        )
        assert_matches_type(Optional[HoldingListResponse], holding, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncTradesignals) -> None:
        response = await async_client.etfs.holdings.with_raw_response.list(
            "ticker",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncTradesignals) -> None:
        async with async_client.etfs.holdings.with_streaming_response.list(
            "ticker",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncTradesignals) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `ticker` but received ''"):
            await async_client.etfs.holdings.with_raw_response.list(
                "",
            )
