...
class TestGreekflow:
    ...
    def test_method_list(self, client: TradesignalsIo) -> None:
        greekflow = client.options.greekflow.list()
        assert_matches_type(GreekflowListResponse, greekflow, path=["response"])
    ...
    def test_raw_response_list(self, client: TradesignalsIo) -> None:
        response = client.options.greekflow.with_raw_response.list()

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        greekflow = response.parse()
        assert_matches_type(GreekflowListResponse, greekflow, path=["response"])

    @parametrize
    def test_streaming_response_list(self, client: TradesignalsIo) -> None:
        with client.options.greekflow.with_streaming_response.list() as response:
...
class TestAsyncGreekflow:
    ...
    async def test_method_list(self, async_client: AsyncTradesignalsIo) -> None:
        greekflow = await async_client.options.greekflow.list()
        assert_matches_type(GreekflowListResponse, greekflow, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncTradesignalsIo) -> None:
        response = await async_client.options.greekflow.with_raw_response.list()

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        greekflow = await response.parse()
        assert_matches_type(GreekflowListResponse, greekflow, path=["response"])

    @parametrize
    async def test_streaming_response_list(self, async_client: AsyncTradesignalsIo) -> None:
        async with async_client.options.greekflow.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
