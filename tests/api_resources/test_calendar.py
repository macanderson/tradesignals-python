...
class TestCalendar:
    ...
    def test_raw_response_retrieve(self, client: Tradesignals) -> None:
        response = client.calendar.with_raw_response.retrieve()
    ...
    def test_streaming_response_retrieve(self, client: Tradesignals) -> None:
        with client.calendar.with_streaming_response.retrieve() as response:
...
class TestAsyncCalendar:
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncTradesignals) -> None:
        response = await async_client.calendar.with_raw_response.retrieve()
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncTradesignals) -> None:
        async with async_client.calendar.with_streaming_response.retrieve() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
